...
const Home = () => {
	...
	return (
		<div className="container d-flex flex-column justify-content-center align-text-center align-items-center my-5">
			<div className="font-title fs-1">
				<h1>ToDos</h1>
			</div>
			<input className="d-flex align-items-center align-text bg-light box border mt-5 p-3 font"
				type="text"
			...
			<div>
				{listReminder.map((item, index) => {
					return (
						<div className="d-flex align-items-center justify-content-between align-text bg-light box border p-3 font" key={index}>
							<div>{item.label}</div>
							<div>
